...
class Edubin_Elementor_Video_PopUp extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '4'                         => __('Style 4', 'edubin'),
                    '5'                         => __('Style 5', 'edubin'),
                    'edubin-video-popup-left'  => __('Style 6', 'edubin'),
                    'edubin-video-popup'       => __('Style 7', 'edubin'),
                    'edubin-video-popup-round' => __('Style 8', 'edubin'),
                ],
            ]
        );
        $this->add_control(
            'popup_text',
            [
                'label'       => __('Video PopUp Text', 'edubin'),
                'type'        => Controls_Manager::TEXT,
                'default'     => __('Play Video', 'edubin'),
                'placeholder' => __('Play Video', 'edubin'),
                'condition' => [
                    'video_style' => '2',
                ],
            ]
        ...
        $this->add_control(
            'video_type',
            [
                'label'   => __('Video Source', 'edubin'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'youtube',
                'options' => [
                    'youtube' => __('YouTube', 'edubin'),
                    'vimeo'   => __('Vimeo', 'edubin'),
                ],
            ]
        );
        ...
        $this->add_control(
            'video_link',
            [
                'label'       => __('Link', 'edubin'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your YouTube link', 'edubin'),
        ...
        $this->add_control(
            ...
            [
                'label'       => __('Link', 'edubin'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your Vimeo link', 'edubin'),
        ...
        $this->add_responsive_control(
            'align',
            [
                'label' => __( 'Alignment', 'edubin' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'edubin' ),
                        'icon' => 'fa fa-align-left',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'edubin' ),
                        'icon' => 'fa fa-align-center',
                    ],
                    'right' => [
                        'title' => __( 'Right', 'edubin' ),
        ...
        $this->add_control(
            'play_bg_size',
            [
                'label'     => __('Play Background Size', 'edubin'),
        ...
        $this->add_control(
            'play_icon_size',
            [
                'label'     => __('Play Icon Size', 'edubin'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
