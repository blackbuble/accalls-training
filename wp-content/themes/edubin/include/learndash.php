                ...
                <div class="single-maylike">
                    ...
                    <ul>
                        ...
                        <?php if ($custom_views_number) : ?>
                           <li class="enroll-student"><i class="glyph-icon flaticon-binoculars-1"></i> <?php echo esc_attr($custom_views_number); ?></li>
                        <?php else : ?>

                          <?php if(function_exists('edubinGetPostViewsCustom')){ ?>
                            <li class="enroll-student"><i class="glyph-icon flaticon-binoculars-1"></i> <?php echo esc_attr(edubinGetPostViewsCustom(get_the_ID())); ?></li>
                          <?php } ?>
                        <?php endif; ?>
