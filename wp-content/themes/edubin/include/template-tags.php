...
function edubin_posted_on() {
	...
	echo '<li class="byline list-inline-item"> '
	 . $byline . '</li><li class="posted-on list-inline-item"><i class="glyph-icon flaticon-event"></i>' . edubin_time_link() . '</li>';
}
endif;
...
function edubin_posted_date() {
	// Finally, let's write all of this to the page.
	echo '<li class="posted-on list-inline-item"><i class="glyph-icon flaticon-event"></i>' . edubin_time_link() . '</li>';
}
endif;
