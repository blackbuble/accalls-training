...
<?php if ( is_active_sidebar( 'edubin-tutor-login-popup-form-before-widget' ) ) : ?>
    <div class="edubin-tutor-login-popup-form-before-widget-wrapper">
        <?php dynamic_sidebar( 'edubin-tutor-login-popup-form-before-widget' ); ?>
    </div>
<?php endif; ?>
...
<?php //wp_login_form(); ?>
    ...
    $args = array(
	    ...
	    'form_id'                   => 'loginform',
	    'label_username'            => __( 'Username or Email Address', 'edubin' ),
	    'label_password'            => __( 'Password', 'edubin' ),
	    'label_remember'            => __( 'Remember Me', 'edubin' ),
	    'label_log_in'              => __( 'Log In', 'edubin' ),
	    'label_create_new_account'  => __( 'Create a new account', 'edubin' ),
	    ...
	    'wp_lostpassword_label'     => __('Forgot Password?', 'edubin'),
    );
    ...
    ?>
<?php if ( is_active_sidebar( 'edubin-tutor-login-popup-form-after-widget' ) ) : ?>
    <div class="edubin-tutor-login-popup-form-after-widget-wrapper">
        <?php dynamic_sidebar( 'edubin-tutor-login-popup-form-after-widget' ); ?>
    </div>
<?php endif; ?>
