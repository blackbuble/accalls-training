...
if ($instructors){
	?>
	<h4 class="tutor-segment-title edubin-tutor-segment-title"><?php _e('About the instructors', 'edubin'); ?></h4>
			...
			<div class="single-instructor-wrap">
				...
				<div class="single-instructor-bottom">
					<div class="ratings">
						...
						echo " <span class='rating-total-meta'>({$instructor_rating->rating_count} ".__('ratings', 'edubin').")</span> ";
						?>
					</div>
					...
					<div class="courses">
						<p>
							...
							<?php echo tutor_utils()->get_course_count_by_instructor($instructor->ID); ?> <span class="tutor-text-mute"> <?php _e('Courses', 'edubin'); ?></span>
						</p>
					</div>
					...
					<div class="students">
						...
						<p>
							...
							<span class="tutor-text-mute">  <?php _e('students', 'edubin'); ?></span>
						</p>
					</div>
				</div>
			</div>
