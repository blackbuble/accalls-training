...
<form class="edugin-tutor-instructor-registration" method="post" enctype="multipart/form-data">
    ...
    <?php if ( is_active_sidebar( 'edubin-tutor-instructor-reg-form-before-widget' ) ) : ?>
        <div class="tutor-form-row">
            <div class="tutor-form-col-12">
                <div class="edubin-tutor-instructor-reg-form-before-widget-wrapper">
                    <?php dynamic_sidebar( 'edubin-tutor-instructor-reg-form-before-widget' ); ?>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="tutor-form-row">
        <div class="tutor-form-col-12">
            <div class="tutor-form-group tutor-reg-form-btn-wrap">
                <button type="submit" name="tutor_register_instructor_btn" value="register" class="tutor-button"><?php _e('Register as instructor', 'edubin'); ?></button>
            </div>
        </div>
    </div>

    <?php if ( is_active_sidebar( 'edubin-tutor-instructor-reg-form-after-widget' ) ) : ?>
        <div class="tutor-form-row">
            <div class="tutor-form-col-12">
                <div class="edubin-tutor-instructor-reg-form-after-widget-wrapper">
                    <?php dynamic_sidebar( 'edubin-tutor-instructor-reg-form-after-widget' ); ?>
                </div>
            </div>
        </div>
    <?php endif; ?>
