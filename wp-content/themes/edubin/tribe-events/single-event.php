...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    $tbe_event_date = get_theme_mod('tbe_event_date', $defaults['tbe_event_date']); 
            ...
            <div class="col-lg-4">
                ...
                <div class="events-right">
                    ...
                    <div class="events-address">
                        ...
                        <?php endif;?>
                        <?php if (!empty($event_date) && $tbe_event_date): ?>
                            <li>
                                <div class="single-address">
                                    <div class="icon">
                                    ...
                                    <div class="cont">
                                        <h6><?php esc_html_e('Event Date', 'edubin');?></h6>
                                       <span><?php echo esc_html($event_date); ?></span>
                                    </div>
                                </div> <!-- single address -->
                            </li>
                        <?php endif;?>
                        <?php if (!empty($start_time) && $tbe_start_time): ?>
                            <li>
                                <div class="single-address">
                                    <div class="icon">
                        ...
                        <?php endif;?>
                        <?php if (!empty($end_time) && $tbe_end_time): ?>
                            <li>
                                <div class="single-address">
                                    <div class="icon">
