...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
    ...
    class Envato_Theme_Setup_Wizard {
        ...
        public function get_logo_image() {
            $image_url = get_theme_mod( 'logo_header_image', get_template_directory_uri() . '/assets/images/logo.png' );
            ...
            <body class="envato-setup wp-core-ui">
                <h1 id="wc-logo">
                    ...
                    if ( $image_url ) {
                        ...
                        <img src="<?php echo esc_url( $this->plugin_url . 'images/logo.png' ); ?>" alt="<?php esc_attr_e( 'Envato install wizard', 'edubin' );?>" /><?php
                    } ?>
                </h1>
                <?php
            }
        ...
        public function envato_setup_introduction() {
            ...
            if ( false && isset( $_REQUEST['debug'] ) ) {
                ...
                <p class="envato-setup-actions step">
                    ...
                    ?>
                    <h1><?php printf( __( 'Welcome to the setup wizard for %s.','edubin' ), wp_get_theme() ); ?></h1>
                    <h3><a target="_blank" href="https://www.youtube.com/watch?v=FoXWLqJPZz0"><?php printf( __( 'Click to see Theme Install & Import Demo Content Video Guide','edubin' )); ?></a></h3>
                    <p><?php printf( __( 'Thank you for choosing the %s theme from ThemeForest. This quick setup wizard will help you configure your new website. This wizard will install the required WordPress plugins, default content, logo and tell you a little about Help &amp; Support options. It should only take few minutes.','edubin' ), wp_get_theme() ); ?></p>
                    <p><?php esc_html_e( 'No time right now? If you don\'t want to go through the wizard, you can skip and return to the WordPress dashboard. Come back anytime if you change your mind!','edubin' ); ?></p>
                    <p class="envato-setup-actions step">
                        <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                         class="button-primary button button-large button-next"><?php esc_html_e( 'Let\'s Go!','edubin' ); ?></a>
                         <a href="<?php echo esc_url( wp_get_referer() && ! strpos( wp_get_referer(), 'update.php' ) ? wp_get_referer() : admin_url( '' ) ); ?>"
            ...
            <?php if ( function_exists( 'envato_market' ) ) { ?>
                <form method="post">
                    ...
                    if ( count( $my_items ) ) {
                        ...
                        <p><?php esc_html_e( "When an update becomes available it will show in the Dashboard with an option to install.",'edubin' ); ?></p>
                        <p>
                            <em><?php esc_html_e( 'If you have any questions please ','edubin' ); ?><a
                            href="<?php echo esc_url('https://thepixelcurve.com/support/'); ?>" target="_blank"><?php esc_html_e( 'Contact us.','edubin' ); ?></a></em>
                        </p>
                        <p class="envato-setup-actions step">
                            ...
                            value="<?php esc_attr_e( 'Login with Envato','edubin' ); ?>" name="save_step"/>
    ...
    <p>
        <em><?php esc_html_e( 'Advanced Users: If you are going to make changes to the theme source code please use a','edubin' ); ?> <a
            href="//codex.wordpress.org/Child_Themes" target="_blank"><?php esc_html_e( 'Child Theme','edubin' ); ?></a> <?php esc_html_e( 'rather than
         ...
         public function envato_setup_help_support() {
            ...
            <p><?php esc_html_e( 'This theme comes with 6 months item support from purchase date (with the option to extend this period).
                ...
                <li><?php esc_html_e( 'Installation services', 'edubin' ); ?>
            </li>
            <li><?php esc_html_e( 'Help and Support for non-bundled 3rd party plugins (i.e. plugins you install yourself later on)', 'edubin' ); ?></li>
        </ul>
        ...
        public function envato_setup_ready() {
            ...
            data-url="https://themeforest.net/user/pixelcurve/portfolio"
            ...
            <h1><?php esc_html_e( 'Your Website is Ready!','edubin' ); ?></h1>

            <p class="greendata"><?php esc_html_e( 'Congratulations! The theme has been activated and your website is ready. Login to your WordPress
            dashboard to make changes and modify any of the default content to suit your needs.','edubin' ); ?></p>
            <p><?php esc_html_e( 'Please come back and','edubin'); ?> <a href="<?php echo esc_url( __( 'https://themeforest.net/downloads', 'edubin' ) ); ?>" target="_blank"><?php esc_html_e( 'leave a 5-star rating.','edubin'); ?></a>
                <?php esc_html_e( 'if you are happy with this theme','edubin'); ?> <br/><?php esc_html_e( 'Follow','edubin'); ?> 
                <a href="<?php echo esc_url( __( 'https://web.facebook.com/thepixelcurve/', 'edubin' ) ); ?>" target="_blank"><?php esc_html_e( '@Pixelcurve','edubin'); ?></a>
                <?php esc_html_e( 'on Facebook to see updates. Thanks!','edubin'); ?> </p>

                <div class="envato-setup-next-steps">
                    <div class="envato-setup-next-steps-first">
                        <h2><?php esc_html_e( 'Next Steps','edubin' ); ?></h2>
                        <ul>
                            ...
                            <li class="setup-product"><a class="button button-primary button-large"
                               href="<?php echo esc_url($url); ?>"><?php esc_html_e( 'Import Dummy Data', 'edubin' ); ?></a>
                           </li>
                   ...
                   <div class="envato-setup-next-steps-last">
                    <h2><?php esc_html_e( 'More Resources','edubin' ); ?></h2>
                    <ul>
                ...
                if ( !$option || empty($option['oauth']) || empty( $option['oauth'][ $this->envato_username ] ) || empty($envato_items) || empty($envato_items['items']) || !envato_market()->items()->themes( 'purchased' )) {
                    ...
                    if ( ! $dissmissed_time || $dissmissed_time < strtotime('-7 days') ) {
                        ...
                        <div class="notice notice-warning notice-dtbwp-themeupdates is-dismissible">
                            ...
                            <p>
                                <?php printf( __( 'To get full features and functionality make sure you have used the latest version edubin theme and edubin core plugin on your site. Configure the envato market plugin. After configuring it, you can able to update theme and core plugin just using one click.') ); ?> 
                                ...
                                <?php printf( __( 'Or If you need any help, please do not hesitate to contact our support desk. <a target="_blank" class="" href="%s">https://thepixelcurve.com/support/ </a>','edubin' ),  esc_url('https://thepixelcurve.com/support/') ); ?> 
                            </p>      
                        </div>
