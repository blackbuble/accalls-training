...
// event_date 
$wp_customize->add_setting( 'tbe_event_date',
    array(
        'default' => $this->defaults['tbe_event_date'],
        'transport' => 'refresh',
        'sanitize_callback' => 'edubin_switch_sanitization'
    )
);
$wp_customize->add_control( new Edubin_Toggle_Switch_Custom_control( $wp_customize, 'tbe_event_date',
    array(
