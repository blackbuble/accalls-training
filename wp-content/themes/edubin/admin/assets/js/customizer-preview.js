jQuery( document ).ready(function($) {
   ...
   wp.customize('search_menu_icon', function(control) {
      control.on(function( controlValue ) {
			if( controlValue == true ) {
				// If the switch is on, add the search icon
				$('.nav-menu').append('<li class="menu-item menu-item-search"><a href="#" class="nav-search"><i class="glyph-icon flaticon-musica-searcher"></i></a></li>');
			}
			else {
