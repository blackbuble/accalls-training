...
define('EDUBIN_THEME_VERSION', '6.6.7');
/**
...
function edubin_widgets_init()
{
    ...
    if (function_exists('tutor')) {
        ...
        // Tutor login popup after      
        register_sidebar(array(
            'name'          => esc_html__('Tutor LMS Popup Login From Before', 'edubin'),
            'id'            => 'edubin-tutor-login-popup-form-before-widget',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on Tutor LMS login Popup from before section.', 'edubin'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title edubin-wtb-hide">',
            'after_title'   => '</h2>',
        ...
        // Tutor login Popup after
        register_sidebar(array(
            'name'          => esc_html__('Tutor LMS Popup Login From After', 'edubin'),
            'id'            => 'edubin-tutor-login-popup-form-after-widget',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on Tutor LMS login Popup from after section.', 'edubin'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title edubin-wtb-hide">',
            'after_title'   => '</h2>',
...
function edubin_woocommerce_widgets_init()
{
    ...
    if (class_exists('WooCommerce')) {
        ...
        register_sidebar(array(
            'name'          => esc_html__('WooCommerce Single Page', 'edubin'),
...
function edubin_scripts()
{
    ...
    if (class_exists('Mega_Menu') && $header_variations == 'header_v3'):
        wp_enqueue_style('edubin-ultimate-member', get_template_directory_uri() . '/assets/css/max-menu.css', array(), EDUBIN_THEME_VERSION);
    endif;
